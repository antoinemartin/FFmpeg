...
NDK=~/src/android/android-ndk-r6b
...
# -Wl,-T,$PREBUILT/arm-linux-androideabi/lib/ldscripts/armelf.x mentioned by almost every articles over internet, but it is not required to specify at all.
